...
1. Xinming Guo, Guangliang Yang, Haoxiang Zhang, Can Li, Yi Wang, Min Yang. Survey of Language Level Memory Safety. IEEE International Conference on Cyber Resilience and Endogenous Safety & Security (CRESS), 2025. [[PDF](../assets/2026.sok_language_level_security.pdf)]
...
4. Youkun Shi, Yuan Zhang, Tianhan Luo, Guangliang Yang, Shengke Ye, Chengyu Yang, Fengyu Liu, Xiapu Luo, Min Yang. PHPJoy: A Novel Extended Graph-based PHP Code Analysis Framework. IEEE Transactions on Software Engineering (TSE), 2025.
   
5. Fengyu Liu, Yuan Zhang, Tian Chen, Youkun Shi, Guangliang Yang, Zihan Lin, Min Yang, Junyao He, Qi Li. Detecting Taint-Style Vulnerabilities in Microservice-Structured Web Applications. IEEE S&P, 2025.  
<span style="color:red">*Distinguished Paper Award*</span>  

6. Zihan Lin, Yuan Zhang, Jiarun Dai, Xinyou Huang, Bocheng Xiang, Guangliang Yang, Letian Yuan, Lei Zhang, Fengyu Liu, Tian Chen, Min Yang. Effective Directed Fuzzing with Hierarchical Scheduling for Web Vulnerability Detection. USENIX Security, 2025.

7. Fengyu Liu, Youkun Shi, Yuan Zhang, Guangliang Yang, Enhao Li, Min Yang. MOCGuard: Accurately Detecting Missing-Owner-Check Vulnerabilities in Java Web Applications. IEEE S&P, 2025.

8. Yizhe Shi, Zhemin Yang, Kangwei Zhong, Guangliang Yang, Yifan Yang, Xiaohan Zhang, Min Yang. The Skeleton Keys: A Large Scale Analysis of Credential Leakage in Mini-apps. NDSS, 2025.
...
12. Peng Deng, Zhemin Yang, Lei Zhang, **Guangliang Yang**, Wenzheng Hong, Yuan Zhang, and Min Yang. NestFuzz: Enhancing Fuzzing with Comprehensive Understanding of Input Processing Logic. *ACM CCS*, 2023.   
    
13. Shuai li, Zhemin Yang, **Guangliang Yang**, Hange Zhang, Nan Hua, Yurui Huang, and Min Yang.  Notice the Imposter! A Study on User Tag Spoofing Attack in Mobile Apps. *USENIX Security*, 2023.
